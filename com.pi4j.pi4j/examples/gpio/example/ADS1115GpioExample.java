...
public class ADS1115GpioExample {
	...
	public static void main(String args[]) throws InterruptedException, UnsupportedBusNumberException, IOException {
		...
		//
		// In my testing, I am using a Sharp IR Distance Sensor (GP2Y0A21YK0F) whose
		// voltage never exceeds 3.3 VDC
		...
		GpioPinListenerAnalog listener = new GpioPinListenerAnalog() {
			...
			public void handleGpioPinAnalogValueChangeEvent(GpioPinAnalogValueChangeEvent event) {
				...
				// display output
				System.out.println(" (" + event.getPin().getName() + ") : VOLTS=" + df.format(voltage) + "  | PERCENT="
